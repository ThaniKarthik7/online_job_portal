...
?>
  ...
  <div class="hero-wrap js-fullheight" style="background-image: url('images/image_5.jpg');" data-stellar-background-ratio="0.5">
                            ...
                            <div class="form-field">
                              <div class="select-wrap">
                                ...
                                <select name="category" id="category" class="form-control">
                                  ...
                                  $query = mysqli_query($c, "select * from job_category");
  ...
  $query1 = mysqli_query($c, "SELECT * FROM all_jobs");

  if (isset($_POST['search'])) {
    $keyword = $_POST['key'];
    $category = $_POST['category'];
    $query1 = mysqli_query($c, "SELECT all_jobs LEFT JOIN company ON all_jobs.customer_email = company.admin 
    ...
    <div class="mb-4 mb-md-0 mr-5">
      ...
      <div class="job-post-item-body d-block d-md-flex">
        <div class="mr-3">
          ...
          <span> <?php echo isset($row['company']) ? $row['company'] : 'N/A'; ?></span>
        </div>
        <div>
          ...
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
              ...
              <div class="block-23 mb-3">
                <ul>
                  <li><span class="icon icon-map-marker"></span><span class="text">GIET UNIVERSITY, GUNUPUR, INDIA</span></li>
                  <li><a href="#"><span class="icon icon-phone"></span><span class="text">+91 8252373318</span></a></li>
        ...
        <div class="row">
          <div class="col-md-12 text-center">
            ...
            <p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
              ...
              </script> All rights reserved  <i class="icon-heart text-danger" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">TEAM RRP</a>
