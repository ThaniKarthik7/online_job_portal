      ...
      <form action="" method="post" style="margin:3%; padding :3%;" name="Job_form" id="Job_form">
        ...
        <div>
          ...
          <div class="from-group">
            ...
            <textarea name="Keyword" class="from-control" id="keyword" placeholder="Enterkeyword"></textarea>
          </div>
          <div class="form-group">
            <label for="">Country</label>
            <textarea name="country" class="countries form-control" id="countryId" placeholder="Enter the Country Name"></textarea>
          </div>
          <div class="form-group">
            <label for="">State</label>
            <textarea name="state" class="states form-control" id="stateId" Placeholder="Enter the State Name"></textarea>
          </div>
          <div class="form-group">
            <label for="">City</label>
            <textarea name="city" class="cities form-control" id="cityId" placeholder="Enter the City Name"></textarea>
          </div>
