...
<main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
        ...
        <div class="btn-toolbar mb-2 mb-md-0">
            ...
            <a class="btn btn-primary" href="add_create_job.php">Apply Job</a>
        </div>
    </div>
    ...
    <table id="example" class="display" style="width:100%">
        ...
        $query1 = mysqli_query($c, "SELECT * FROM job_apply");

            $a = 1; 
            $query1 = mysqli_query($c, "SELECT * from  job_apply LEFT JOIN all_jobs ON job_apply.id_job = all_jobs.job_id WHERE customer_email='{$_SESSION['email']}'");
            //var_dump($query1);
        ...
        ?>
            <tr>
                ...
                <td><a href="http://localhost/job_protol/files/<?php echo $row['file']; ?>">Download file</a></td>
                <td>
                    <div class="row">
                        <div class="btn-group">
