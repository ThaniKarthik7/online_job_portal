...
$id = $_GET['edit'];
$query = mysqli_query($c, "SELECT * FROM company WHERE company_id='$id'");
    ...
    <div style="Width : 60%; margin-left : 20%; background-color : #F2F4F4;">
      ...
      <form action="" method="post" style="margin:3%; padding :3%;" name="customer_form" id="customer_form">
        ...
        <div class="from-group">
          ...
          <input type="Company" name="Company" id="Company" value="<?php echo $company_name; ?>" class="from-control" placeholder="Enter company name">
        </div>
        ...
        <div>
          ...
          <div class="from-group">
                    ...
                    <select name="admin" class="from-control" id="admin">
                      <?php
                      include('connection/db.php');
                      $sql = mysqli_query($c, "select * from admin_login where admin_type='2'");
...
if (isset($_POST['submit'])) {
  $id = $_POST['id'];
  $company = $_POST['Company']; // Note the uppercase 'C' for 'Company'
  $des = $_POST['des']; 
  $admin = $_POST['admin'];// Note the lowercase 'd' for 'des'

  $query = mysqli_query($c, "UPDATE company SET company='$company', des='$des', admin='$admin' WHERE company_id='$id'");
